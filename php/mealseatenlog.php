 ...
 <?php
	...
	$sql="select guest.guest_id, guest.name, guest.type, meal_taken.* from mealtaken_guest, guest, meal_taken where mealtaken_guest.guest_id=guest.guest_id and guest.cat_id=$catid and meal_taken.meal_id=mealtaken_guest.meal_id";
...
<html>
    <head>
        <title>Display caterer guest meal log.</title>
    </head>
    
    <body style="text-align:center;"background="back1.jpg">
   <h1> -----VIEW LOG OF MEALS MADE------ </h1>
      ...
      <?php echo $end_err?>
       ...
       <a href = "makemealslog.php" target = "_self"> VIEW ANOTHER LOG <br></a>
