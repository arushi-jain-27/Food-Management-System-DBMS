...
<div class="jumbotron">
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        <input type="text" class="form-control"style="font-size:30px;" id="author" placeholder="Author" name="author" value="<?php echo $auth_name?>">
      </div>
    </div>
    <br/>
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        <input type="text" class="form-control" style="font-size:30px;"id="author" placeholder="Publisher" name="publisher" value="<?php echo $pub_name?>">
      </div>
    </div>
    <br/>
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="language" style="font-size:30px;" placeholder="Language" name="language" value="<?php echo $lang_name?>">
      </div>
    </div>
    <br/>
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        <input type="text" style="font-size:30px;" class="form-control" id="genre" placeholder="Genre" name="genre" value= "<?php echo $genre_name?>">
      </div>
    </div>
    <br/>
